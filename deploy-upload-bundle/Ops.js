...
const APP_BUILD = '1.0.63';
const FORCE_CACHE_PURGE_TOKEN = '2026-02-17-force-purge-12';
...
function registerServiceWorker() {
    ...
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('service-worker.js?v=143').then((registration) => {
